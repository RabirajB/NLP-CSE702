...
def main(filenametodo = 'E:/Joseph-Seminar/EmbeddingDynamicStereotypes-master/run_results/finalrun.csv'):
    plots_folder = 'E:/Joseph-Seminar/EmbeddingDynamicStereotypes-master/plots2/'
